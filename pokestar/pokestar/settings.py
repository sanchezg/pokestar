"""
Django settings for pokestar project.
...
dotenv_path = f"{BASE_DIR}/config/.env.{env}"
...
SECRET_KEY = "django-insecure-51@q538ir#g*mhrb^u*2y+475h=jlmcu+12&90pw_(t0p588$z"
...
WSGI_APPLICATION = "pokestar.wsgi.application"
